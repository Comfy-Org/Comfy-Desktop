...
const CATEGORY_MAP: Record<string, string> = {
  ...
  'default-device': 'gpu',
  'cuda-malloc': 'gpu',
  'disable-cuda-malloc': 'gpu',
  'directml': 'gpu',
  'oneapi-device-selector': 'gpu',
  'disable-ipex-optimize': 'gpu',
  'supports-fp8-compute': 'gpu',
  'gpu-only': 'gpu',
  'highvram': 'gpu',
  'normalvram': 'gpu',
  'lowvram': 'gpu',
  ...
  'reserve-vram': 'gpu',
  'async-offload': 'gpu',
  'disable-async-offload': 'gpu',
  'disable-dynamic-vram': 'gpu',
  'enable-dynamic-vram': 'gpu',
  'fast-disk': 'gpu',
  'force-non-blocking': 'gpu',
  'disable-smart-memory': 'gpu',
  'disable-pinned-memory': 'gpu',
...
const CATEGORY_ORDER = [
  'network', 'launch', 'gpu', 'precision', 'performance',
